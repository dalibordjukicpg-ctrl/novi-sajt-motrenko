    ...
    <main className="min-h-screen w-full min-w-0 overflow-x-hidden bg-transparent">
      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-12 sm:py-16 lg:px-16">
        {isTeam ? (
          ...
          <>
            {post.coverUrl ? (
              <div className="relative -mt-8 mb-10 w-full max-w-3xl">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={post.coverUrl}
                  alt=""
                  className="mx-auto h-auto w-auto max-h-[min(720px,78vh)] max-w-full rounded-2xl border border-zinc-200/80 shadow-lg"
                />
              </div>
            ) : null}
            {post.body ? (
