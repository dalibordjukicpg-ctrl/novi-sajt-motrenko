...
function questionnaireBranding() {
  ...
  const notify =
    process.env.UPITNIK_NOTIFY_EMAIL?.trim() || DEFAULT_NOTIFY_INBOX;
  return {
    clinicName:
...
function buildHtml(d: any, t: QuestionnaireI18n, submissionLocale: Locale = "me"): string {
  ...
  <body style="font-family:Arial,sans-serif;max-width:820px;margin:0 auto;padding:20px;color:#1a1a1a;background:#fff">
    ...
    <p style="font-size:12px;color:#666;margin-top:16px">PDF u prilogu (A4, logo + svi podaci) — otvorite i odštampajte.</p>
