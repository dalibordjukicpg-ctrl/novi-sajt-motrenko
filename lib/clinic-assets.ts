...
/** Poster kadro iz hero videa — odmah vidljiv dok se MP4 učitava. */
export const FALLBACK_HERO_VIDEO_POSTER_REL = "/video/nova-beba-poster.jpg";

/** Lakša 720p verzija hero videa za mobilne uređaje. */
export const FALLBACK_HERO_VIDEO_MOBILE_REL = "/video/nova-beba-720.mp4";
